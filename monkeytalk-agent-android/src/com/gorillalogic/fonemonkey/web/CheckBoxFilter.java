...
public class CheckBoxFilter extends InputFilter {
	public static String[] componentTypes = { "checkbox", "toggle" };
	private static String[] tagNames = { "input" };
	static private String[] types = new String[] { "checkbox" };
