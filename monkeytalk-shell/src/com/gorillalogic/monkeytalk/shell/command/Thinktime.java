...
public class Thinktime extends Timeout {

	public Thinktime(String line, ScriptProcessor processor) {
	...
	public void run() {
		int n = getIntArg();
		if (n >= 0) {
			processor.setGlobalThinktime(n);
			Print.info("thinktime = " + n + "ms");
		} else {
			Print.err("ERROR: bad thinktime");
		}
	}
}
