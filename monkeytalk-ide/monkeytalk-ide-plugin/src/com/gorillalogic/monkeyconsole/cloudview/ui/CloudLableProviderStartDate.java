...
public class 	CloudLableProviderStartDate extends StyledCellLabelProvider {
    MyHyperlink2 m_control;

    public CloudLableProviderStartDate( Composite parent ) {
        m_control = new MyHyperlink2( parent, SWT.WRAP );
    }

    @Override 
    protected void paint( Event event, Object element ) {
        String sValue = ((JobRow)element).getStartTime().toString();
...
class MyHyperlink5 extends Hyperlink {
	
    public MyHyperlink5(Composite parent, int style) {
        super(parent, style);
