...
public class 	CloudLableProviderID extends StyledCellLabelProvider {
    MyHyperlink2 m_control;

    public CloudLableProviderID( Composite parent ) {
        m_control = new MyHyperlink2( parent, SWT.WRAP );
    }

    @Override 
    protected void paint( Event event, Object element ) {
        String sValue = ((JobRow)element).getId() + "";
...
class MyHyperlink3 extends Hyperlink {
	
    public MyHyperlink3(Composite parent, int style) {
        super(parent, style);
