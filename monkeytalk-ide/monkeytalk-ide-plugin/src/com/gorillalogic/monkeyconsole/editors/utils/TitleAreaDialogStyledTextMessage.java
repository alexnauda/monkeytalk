 ...
 */
public class TitleAreaDialogStyledTextMessage extends TrayDialog {
	/**
	 ...
	 */
	public TitleAreaDialogStyledTextMessage(Shell parentShell) {
		super(parentShell);
	}
	...
	public Link getMessageLabel() {
		return messageLabel;
	}

	public void setMessageLabel(Link messageLabel) {
