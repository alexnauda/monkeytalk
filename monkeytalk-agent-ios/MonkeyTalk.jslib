...
/** @namespace <a href="http://www.gorillalogic.com/monkeytalk">MonkeyTalk</a> helper function library for iOS <a href="http://developer.apple.com/library/ios/#documentation/DeveloperTools/Reference/UIAutomationRef/_index.html">UIAutomation</a> scripting 
 @author Gorilla Logic, Inc. - <a href="http://www.gorillalogic.com">www.gorillalogic.com</>
 @see <a href="http://developer.apple.com/library/ios/#documentation/DeveloperTools/Reference/UIAutomationRef/_index.html">UIAutomation Reference</a>, <a href="http://www.gorillalogic.com/monkeytalk">MonkeyTalk Project Home</a>
 */
...
scrollTo: function(tableName, item, group, timeout) {
	var table = MonkeyTalk.elementNamed(tableName, timeout);
	var grp;
...
selectPickerValue: function(pickerName, row, component, timeout) {
	...
	var picker = MonkeyTalk.elementNamed(pickerName, timeout);
...
assertElementValue: function(name, value, timeout) {
	...
	var element = MonkeyTalk.elementNamed(name, timeout);
