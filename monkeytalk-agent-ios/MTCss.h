...
@interface MTCss : MTHTTPVirtualDirectory {
  MTElement *element_;
}
...
// This directory is dynamically added by |MTCss| the first time a request
// is received for |:name|.
@interface MTNamedCssProperty : MTHTTPVirtualDirectory {
  @private
  MTElement* element_;
  NSString* name_;
}
