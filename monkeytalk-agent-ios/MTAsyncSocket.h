...
@class MTAsyncSocket;
@class MTAsyncReadPacket;
@class MTAsyncWritePacket;

extern NSString *const MTAsyncSocketException;
extern NSString *const MTAsyncSocketErrorDomain;
...
@interface NSObject (MTAsyncSocketDelegate)
...
**/
- (void)onSocket:(MTAsyncSocket *)sock didReadPartialDataOfLength:(CFIndex)partialLength tag:(long)tag;
...
@interface MTAsyncSocket : NSObject
{
	...
	MTAsyncReadPacket *theCurrentRead;
	NSTimer *theReadTimer;
	NSMutableData *partialReadBuffer;
	
	NSMutableArray *theWriteQueue;
	MTAsyncWritePacket *theCurrentWrite;
...
/**
 * Once one of these methods is called, the MTAsyncSocket instance is locked in, and the rest can't be called without
 ...
 * The performance can be improved by allowing MTAsyncSocket to read larger chunks at a time and
...
/**
 * When you create an MTAsyncSocket, it is added to the runloop of the current thread.
