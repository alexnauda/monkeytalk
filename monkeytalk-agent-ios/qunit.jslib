...
// ToDo: Wrap this call
MTObjConnect.connect("MTWriteResults",[this.module,this.testName,assertionMessage],null);
	},
...
// ToDo: Wrap this call
MTObjConnect.connect("MTWriteResultsDone",[config.stats.all,config.stats.bad,runtime],null);
