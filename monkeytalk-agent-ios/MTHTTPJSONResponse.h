...
// |MTHTTPJSONResponse| wraps |MTHTTPDataResponse| for JSON data. It is used to
...
@interface MTHTTPJSONResponse : MTHTTPDataResponse {

}

// Create an |MTHTTPJSONResponse| from the object. The object is serialised to
// JSON immediately.
