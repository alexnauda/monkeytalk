...
public interface Input {
	 ...
	 */
	public void enterText(Map<String, String> mods);
	/**
	 * Enter text into the input field.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterText(String text, Map<String, String> mods);
	/**
	 * Enter text into the input field.
	 * @param text the text to enter
	 * @param hitEnter if 'enter', hit the Enter/Return/Done/Next key after entering the text.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterText(String text, String hitEnter, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void clear(Map<String, String> mods);
