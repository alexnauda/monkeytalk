...
public interface DatePicker {
	 ...
	 */
	public void enterDate(Map<String, String> mods);
	/**
	 * Enter the date value.
	 * @param date A date with the format YYYY-MM-DD where YYYY is the year, MM is the month (01-12), and DD is the day (01-31).
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterDate(String date, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterTime(Map<String, String> mods);
	/**
	 * Enter the time value.
	 * @param time A time with the format hh:mm am/pm, where hh is the hour (01-12), mm is the minute (00-59), and am/pm is the marker.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterTime(String time, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterDateAndTime(Map<String, String> mods);
	/**
	 * Enter the date and time value.
	 * @param dateAndTime A date and time with the format YYYY-MM-DD hh:mm am/pm, where YYYY is the year, MM is the month (01-12), DD is the day (01-31), hh is the hour (01-12), mm is the minute (00-59), and am/pm is the marker.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterDateAndTime(String dateAndTime, Map<String, String> mods);

	/**
	 * Enter the count down timer value. (iOS only)
	 */
	public void enterCountDownTimer();
	/**
	 * Enter the count down timer value. (iOS only)
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterCountDownTimer(Map<String, String> mods);
	/**
	 * Enter the count down timer value. (iOS only)
	 * @param timer A timer with the format hh:mm, where hh is the hour (00-23), and mm is the minute (00-59).
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void enterCountDownTimer(String timer, Map<String, String> mods);
