...
public interface Table {
	 ...
	 */
	public void selectRow(Map<String, String> mods);
	/**
	 * Select a row.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectRow(int row, Map<String, String> mods);
	/**
	 * Select a row.
	 * @param row the row to select
	 * @param section the section containing the row, defaults to section #1. (Ignored on Android)
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectRow(int row, int section, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectIndicator(Map<String, String> mods);
	/**
	 * Select the indicator (the icon on the right). Android: Ignored.
	 * @param row the row to select
	 */
	public void selectIndicator(int row);
	/**
	 * Select the indicator (the icon on the right). Android: Ignored.
	 * @param row the row to select
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectIndicator(int row, Map<String, String> mods);
	/**
	 * Select the indicator (the icon on the right). Android: Ignored.
	 * @param row the row to select
	 * @param section the section containing the row, defaults to section #1.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectIndicator(int row, int section, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void scrollToRow(Map<String, String> mods);
	/**
	 * Scroll to a row by row number.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void scrollToRow(int row, Map<String, String> mods);
	/**
	 * Scroll to a row by row number.
	 * @param row the row to scroll to
	 * @param section the section containing the row, defaults to section #1. (Ignored on Android)
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void scrollToRow(int row, int section, Map<String, String> mods);

	/**
	 * Scroll to a row by value.
	 * @param value the value of the row to scroll to.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void scrollToRow(String value, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void setEditing(Map<String, String> mods);
	/**
	 * Enable/disable table editing. iOS: Enabled editing mode for table. Android: ignored.
	 * @param enabled if true, enable editing, else disable editing.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void setEditing(boolean enabled, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void insert(Map<String, String> mods);
	/**
	 * Insert a row into the table. iOS: Inserts a row. Android: Ignored.
	 * @param row the index of the row after which to insert a new row.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void insert(int row, Map<String, String> mods);
	/**
	 * Insert a row into the table. iOS: Inserts a row. Android: Ignored.
	 * @param row the index of the row after which to insert a new row.
	 * @param section the section containing the row, defaults to section #1.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void insert(int row, int section, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void remove(Map<String, String> mods);
	/**
	 * Remove a row from the table. iOS: Deletes the row. Android: Ignored.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void remove(int row, Map<String, String> mods);
	/**
	 * Remove a row from the table. iOS: Deletes the row. Android: Ignored.
	 * @param row the index of the row to be removed.
	 * @param section the section containing the row, defaults to section #1.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void remove(int row, int section, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void move(Map<String, String> mods);
	/**
	 * Move a row. iOS: Moves a row. Android: Ignored.
	 * @param from the index of the row to be moved.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void move(int from, Map<String, String> mods);
	/**
	 * Move a row. iOS: Moves a row. Android: Ignored.
	 * @param from the index of the row to be moved.
	 * @param to the destination row for the move.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void move(int from, int to, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void select(Map<String, String> mods);
	/**
	 * Select an item by value.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void select(String value, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void longSelect(Map<String, String> mods);
	/**
	 * Long select an item by value.
	 * @param value the value of the item to select.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void longSelect(String value, Map<String, String> mods);
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectIndex(Map<String, String> mods);
	/**
	 * Selects an item by index.
	 * @param itemNumber the index of the item to select.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void selectIndex(int itemNumber, Map<String, String> mods);

	/**
	 * Long press an item by index.
	 */
	public void longSelectIndex();
	/**
	 * Long press an item by index.
	 * @param mods the MonkeyTalk modifiers
	 */
	public void longSelectIndex(Map<String, String> mods);
	/**
	 * Long press an item by index.
	 * @param itemNumber the index of the item to long press.
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void longSelectIndex(int itemNumber, Map<String, String> mods);
