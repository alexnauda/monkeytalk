...
bot.Device.MUST_MANUALLY_FOLLOW_LINKS_ = !(goog.userAgent.WEBKIT || goog.userAgent.OPERA || bot.userAgent.FIREFOX_EXTENSION && bot.userAgent.isProductVersion(3.6));
...
webdriver.atoms.inject.action.click = function(a) {
  bot.inject.executeScript(bot.action.click, [a], !0)
};
